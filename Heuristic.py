...
class Heuristic:
    ...
    def getNumberOfWinningConfigurations(self,searchPosition,game):
        ...
        if ( 1<=i<=8 and 1<=j<=10):
			if (
			    gameGrid[i+1][j+1] == None or gameGrid[i+1][j+1].get_tokenColour() == game.getPlayers()[0].get_playerColour() and
				gameGrid[i+1][j-1] == None or gameGrid[i+1][j-1].get_tokenColour() == game.getPlayers()[0].get_playerColour() and
				gameGrid[i-1][j+1] == None or gameGrid[i-1][j+1].get_tokenColour() ==  game.getPlayers()[0].get_playerColour() and 
				gameGrid[i-1][j-1] == None or gameGrid[i-1][j-1].get_tokenColour() == game.getPlayers()[0].get_playerColour()
			):
				if (
					gameGrid[i][j-1] == None or gameGrid[i][j-1].get_tokenColour() == game.getPlayers()[0].get_playerColour()  and
					gameGrid[i][j+1] == None or gameGrid[i][j+1].get_tokenColour() == game.getPlayers()[0].get_playerColour() 
        ...
        if ( 0<=i<=7 and 0<=j<=9 ):
			if (
				gameGrid[i][j+2] == None or gameGrid[i][j+2].get_tokenColour() == game.getPlayers()[0].get_playerColour() and
				gameGrid[i+1][j+1] == None or gameGrid[i+1][j+1].get_tokenColour() == game.getPlayers()[0].get_playerColour() and
				gameGrid[i+2][j] == None or gameGrid[i+2][j].get_tokenColour() == game.getPlayers()[0].get_playerColour() and 
				gameGrid[i+2][j+2] == None or gameGrid[i+2][j+2].get_tokenColour() == game.getPlayers()[0].get_playerColour()
			):
				if (
					gameGrid[i+1][j] == None or gameGrid[i+1][j].get_tokenColour() == game.getPlayers()[0].get_playerColour() and
					gameGrid[i+1][j+2] == None or gameGrid[i+1][j+2].get_tokenColour() == game.getPlayers()[0].get_playerColour()
					):
					    numberOfWinningConfigurations += 1
        ...
        if ( 0<=i<=7 and 2<=j<=11 ):	
            if (
                gameGrid[i][j-2] == None or gameGrid[i][j-2].get_tokenColour() == game.getPlayers()[0].get_playerColour() and
                gameGrid[i+1][j-1] == None or gameGrid[i+1][j-1].get_tokenColour() == game.getPlayers()[0].get_playerColour() and
                gameGrid[i+2][j-2] == None or gameGrid[i+2][j-2].get_tokenColour() == game.getPlayers()[0].get_playerColour() and 
                gameGrid[i+2][j] == None or gameGrid[i+2][j].get_tokenColour() == game.getPlayers()[0].get_playerColour()
            ):
                if (
                    gameGrid[i+1][j] == None or gameGrid[i+1][j].get_tokenColour() == game.getPlayers()[0].get_playerColour() and
                    gameGrid[i+1][j-2] == None or gameGrid[i+1][j-2].get_tokenColour() == game.getPlayers()[0].get_playerColour()
