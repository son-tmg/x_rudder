...
If an row and column position is entered for a position that is already occupied, you will be re-promtpted to enter the row and column.
...
"
Which mode would you like to play? (1-Player vs Player, 2-Player vs AI): 2
Welcome Player 1, as an artificially intelligent agent, your name will be AI. 
Welcome Player 2, please enter your name: player_2
Welcome AI , you will be playing in the token colour █ , with the starting amount of 15 tokens.
Welcome player_2 , you will be playing in the token colour ░ , with the starting amount of 15 tokens.
"

For any given round, the AI will always make the first move within 5 seconds and the game grid will be printed.
Then, the player will be prompted to make a move.
Refer to the first part on how placements and movements will take place.